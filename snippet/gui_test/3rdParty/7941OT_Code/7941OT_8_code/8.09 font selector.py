...
class FontSelectorDemo():
   ...
   def __init__(self):
      self.currentfont     = tkinter.font.Font(font=('Times New Roman', 12))
      self.family          = StringVar(value='Times New Roman')
      self.fontsize        = StringVar(value='12')
      self.fontweight      = StringVar(value=tkinter.font.NORMAL)
      self.slant           = StringVar(value=tkinter.font.ROMAN)
